...
const ClientDashboard = () => {
  ...
  const toggleWebsiteStatus = async (websiteId: string, currentStatus: boolean) => {
    try {
      ...
      const statusMessage = !currentStatus ? 'تم تفعيل الموقع وإيقاف المواقع الأخرى تلقائياً' : 'تم إيقاف الموقع';
      toast({
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              ...
              {accountId && <p className="text-sm text-gray-600">معرف الحساب: {accountId}</p>}
